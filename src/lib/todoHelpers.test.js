import {addTodo, toggleTodo, findById, updateTodo, removeTodo} from './todoHelpers';

test('addTodo should add the passed todo to the beginning list', () => {
    const startTodos = [
...
test('removeTodo should remove and item by id', () => {
    const startTodos = [
        {id:1, name:'one', isComplete:false},
        {id:2, name:'two', isComplete:false},
        {id:3, name:'three', isComplete:false}
